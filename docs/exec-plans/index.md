...
- [Linked Worktree Git Metadata Guard](review/2026-08-07-linked-worktree-git-metadata-guard-exec-plan.md)
...
- [Generic agents-safe Command Launcher](completed/2026-07-15-agents-safe-command-exec-plan.md)
- [Internal Naming and Container Terminology](completed/2026-07-16-internal-naming-terminology-exec-plan.md)
- [Docker CLI Transport Rollback](completed/2026-07-16-docker-cli-rollback-exec-plan.md)
- [Launcher Package Boundaries](completed/2026-07-16-launcher-package-boundaries-exec-plan.md)
- [Moby Engine Client Migration — cancelled](completed/2026-07-16-moby-engine-client-exec-plan.md)

## Deferred Work

- Long-lived deferred work promoted from plans or reviews is tracked in the
