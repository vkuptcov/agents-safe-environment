...
- [Project Launcher Configuration](project-launcher-configuration.md): proposed typed project defaults, TOML
  serialization, CLI precedence, and local `.agents-safe/.gitignore` behavior.
