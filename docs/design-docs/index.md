...
- [Project-Specific Agent Environments](project-environments.md): project-owned derived images, confirmation,
  host-side Docker build boundaries, caching, compatibility, and active-session reuse.
