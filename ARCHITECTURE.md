...
| `internal/launcher/projectenv/` | Validates and hashes project Docker build contexts. | [Project environments](docs/design-docs/project-environments.md) |
...
- Project-image discovery, confirmation, caching, compatibility, and active-session labels belong to
